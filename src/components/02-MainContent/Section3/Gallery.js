...
const Gallery = () => {
    ...
    const images = [
        '/02-maincontent/section3/gallery_01.jpeg',
        '/02-maincontent/section3/gallery_02.jpeg',
        '/02-maincontent/section3/gallery_03.jpeg',
        '/02-maincontent/section3/gallery_04.jpeg',
        '/02-maincontent/section3/gallery_05.jpeg',
        '/02-maincontent/section3/gallery_06.jpeg',
        '/02-maincontent/section3/gallery_08.jpeg',
        '/02-maincontent/section3/gallery_07.jpeg',
        '/02-maincontent/section3/gallery_09.jpeg',
        '/02-maincontent/section3/gallery_10.jpeg',
        '/02-maincontent/section3/gallery_11.jpeg',
        '/02-maincontent/section3/gallery_12.jpeg',
        '/02-maincontent/section3/gallery_14.jpeg',
        '/02-maincontent/section3/gallery_13.jpeg',
        '/02-maincontent/section3/gallery_15.jpeg'
    ];
    ...
    const showHearts = () => {
        ...
        for (let i = 0; i < 30; i++) {
            setTimeout(() => {
                ...
                // 무작위로 이미지 선택
                const heartImage = Math.random() > 0.5 ? '/02-maincontent/section3/heart1.png' : '/02-maincontent/section3/heart2.png';
    ...
    const showHeartGif = (x, y) => {
        ...
        gif.style.backgroundImage = "url('/02-maincontent/section3/heart-animation.gif')"; // GIF 파일 경로
                        ...
                        {images.map((src, index) => (
                            <SwiperSlide key={index}>
                                ...
                                <div className="like-section">
                                    ...
                                    >
                                        <img 
                                            src="/02-maincontent/section3/heart3.png" 
                                            alt="Heart Icon" 
