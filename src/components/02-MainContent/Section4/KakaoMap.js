...
const KakaoMap = () => {
    ...
    useEffect(() => {
        const loadKakaoMap = () => {
            ...
            const options = {
                center: new window.kakao.maps.LatLng(37.2627401, 126.9965417), // 좌표 설정
                level: 5, // 지도 확대 수준
            };

            const map = new window.kakao.maps.Map(container, options);
            const markerPosition = new window.kakao.maps.LatLng(37.2627401, 126.9965417); // 마커 위치 설정
        ...
        <div data-aos="fade-up" data-aos-duration="1500" data-aos-delay="200" style={{ padding: '30px', marginTop:"30px", backgroundColor:"#fcfaf8" }}>
            ...
            <div style={{ paddingBottom: '0.7rem', textAlign: 'center' }}>
                ...
                <div style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', marginTop: '5px', marginBottom:'10px' }}>
                    ...
                    <img
                        src="/02-maincontent/section4/copy.png"
                        alt="복사하기"
